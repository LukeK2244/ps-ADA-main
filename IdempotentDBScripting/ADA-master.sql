...
CALL IDEM_SP_DDL_UTIL_ADD_FIELD_IF_NOT_EXISTS ('ADA_TASK_ENTITY', 'PROJECT_VERSION_ID', 'int(11) DEFAULT NULL', 'PROJECT_ID');
CALL IDEM_SP_DDL_UTIL_ADD_FIELD_IF_NOT_EXISTS ('ADA_TASK_ENTITY', 'CHILD_ENTITY_TYPE_ID', 'int(11) DEFAULT NULL', 'ENTITY_TYPE_ID');
...
(64, 4, 'Description', "/*[name()='xsd:schema']/*[name()='xsd:complexType']/*[name()='xsd:annotation']/*[name()='xsd:documentation']/text()", 1, 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
-- 81-100 for decision
